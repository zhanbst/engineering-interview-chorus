...
const POKEMON_DATA: Partial<Pokemon>[] = [
  { id: 1, name: 'bulbasaur' },
  { id: 2, name: 'ivysaur' },
  { id: 3, name: 'venusaur' },
...
export class PokemonSeedService implements OnModuleInit {
  private readonly logger = new Logger(PokemonSeedService.name);
  ...
  async onModuleInit(): Promise<void> {
    ...
    if (count === 0) {
      this.logger.log('Seeding 150 Pokemon...');
      await this.pokemonRepository.save(POKEMON_DATA);
      this.logger.log('Pokemon seeding complete.');
    }
  }
}
